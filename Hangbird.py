...
Icon = pygame.image.load(
    base_path + r"Hangbird game\sprites\hangman phases\phase 6.png"
)
pygame.display.set_icon(Icon)

bg_image = pygame.image.load(
    base_path + r"Hangbird game\sprites\green fields.png"
)
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.surf = pygame.image.load(
            base_path + r"Hangbird game\sprites\Hbird7.png"
        ).convert()
...
class Obstacle(pygame.sprite.Sprite):
    ...
    def __init__(self, obstacle_position):
        ...
        super().__init__()
        self.surf = pygame.image.load(
            base_path + r"Hangbird game\sprites\obstacles\%s.png"
            % obstacle_position
        ).convert()
        self.surf.set_colorkey((0, 0, 0), RLEACCEL)
...
class Letter(ColoredLetter):
    ...
    wrong_letter_sound = pygame.mixer.Sound(
        base_path + r"Hangbird game\music\wrong letter + collision.mp3"
    )
    correct_letter_sound = pygame.mixer.Sound(
        base_path + r"Hangbird game\music\correct letter + powerup.mp3"
    )
    the_abc = [
        "A",
        "B",
...
class Hangman(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.surf = pygame.image.load(
            base_path + r"Hangbird game\sprites\hangman phases\phase %s.png"
            % Hangman.phase_num
        ).convert()
...
class Powerup(pygame.sprite.Sprite):
    ...
    def __init__(self, powerup):
        ...
        super().__init__()
        self.surf = pygame.image.load(
            base_path + r"Hangbird game\sprites\powerups\%s.png"
            % powerup
        ).convert()
        self.surf.set_colorkey((255, 255, 255), RLEACCEL)
...
class Heart(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.surf = pygame.image.load(
            base_path + r"Hangbird game\sprites\heart.png"
        ).convert()
        self.surf.set_colorkey((255, 255, 255), RLEACCEL)
...
pygame.mixer.music.load(
    base_path + r"Hangbird game\music\background music.wav"
)
